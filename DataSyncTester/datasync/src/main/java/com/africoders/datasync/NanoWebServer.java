...
public class NanoWebServer extends NanoHTTPD {
    ...
    public String TAG = "DataServer";
    public Context mContext;



    public NanoWebServer(int port, Context context) {
        super(port);
        mContext=context;
        Initialize();
    }
    ...
    public NanoWebServer(String hostname, int port, Context context) {
        super(hostname, port);
        mContext=context;
        Initialize();
    }
    ...
    public Response serve(IHTTPSession session) {
        ...
        if(path.contains("api/data")) {
            //api request
            String subpath=path.replace("/api/data/","");
